...
export const LANDING_IMAGES: Record<LandingImageKey, LandingImageMeta> = {
  ...
  galleryDelivery: {
    src: "/images/landing/gallery-delivery.png",
    alt: "Courier handing a package to a customer",
    label: "Package handoff",
    filename: "gallery-delivery.png",
  },
  galleryTracking: {
    src: "/images/landing/gallery-tracking.png",
    alt: "Customer tracking a shipment on their phone",
    label: "Live tracking on mobile",
    filename: "gallery-tracking.png",
  },
  galleryRider: {
    src: "/images/landing/gallery-rider.png",
    alt: "Rider on a motorcycle with delivery bag",
    label: "Rider on the road",
    filename: "gallery-rider.png",
  },
  galleryWarehouse: {
    src: "/images/landing/gallery-warehouse.png",
    alt: "Packages organized at a logistics hub",
    label: "Logistics hub",
    filename: "gallery-warehouse.png",
  },
  stepQuote: {
