...
import { verifyEmail, resendOTP, AUTH_PURPOSES } from "@/lib/auth-api";
...
function VerifyEmailForm() {
  ...
  async function handleResend() {
    ...
    const res = await resendOTP({ email, purpose: AUTH_PURPOSES.EMAIL_VERIFICATION });
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div className="text-center">
        <h1 className="text-xl sm:text-2xl font-bold text-[#81007f]">Verify your email</h1>
